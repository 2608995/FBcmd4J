...
Importar a NetBeans
Clic en File -> Import -> Existing Projects into Workspace. Seleccionar carpeta donde se clonó el proyecto. Maven install. Exportar .war
...
GET: Descarga un archivo mediante el parámetro path. api/v1/file/?path= POST: Sube un archivo mediante los parámetros name, dir y file. api/v1/file/ name="imagen.jpg" dir="/Files" file@/Users/User/Downloads/imagen.jpg --form DELETE: Elimina un archivo mediante el parámetro path. api/v1/file/?path= OPTIONS: Documentación del recurso. Recurso api/v1/directory
GET: Lista los archivos de un directorio mediante el parámetro dir. api/v1/directory/?dir= OPTIONS: Documentación del recurso. Recurso api/v1/notify
GET: Lista las notificaciones enviadas. POST: Envía una notificación mediante los parámetros subject, message, toAddress y ccAddress. api/v1/notify subject="hello" message="Hello from Spring" toAddress="" ccAddress="" OPTIONS: Documentación del recurso. Recurso api/v1/user
